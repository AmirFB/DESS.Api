    ...
    public partial class DatabaseRefreshed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 1, false, false, (byte)0, false, null, true, (byte)70, (byte)2, (short)3000, (byte)10, "38.0962", "46.2738", true, "Ef1", null, "001", "ehp-ie-tbz", false, (sbyte)0, (sbyte)0, false, false }, { 2, false, false, (byte)0, false, null, true, (byte)70, (byte)3, (short)4000, (byte)15, "35.6892", "51.3890", false, "Ef2", null, "002", "ehp-ie-thr", false, (sbyte)0, (sbyte)0, false, false }, { 3, false, false, (byte)0, false, null, true, (byte)80, (byte)2, (short)5000, (byte)20, "32.6539", "51.6660", false, "Ef3", null, "003", "ehp-ie-isf", false, (sbyte)0, (sbyte)0, false, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 1, true, 1, null, 0 }, { 4, true, 1, null, 1 }, { 6, false, 3, null, 1 }, { 3, true, 3, null, 0 }, { 5, true, 2, null, 0 }, { 2, true, 2, null, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 1, (byte)0, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, null, false, false, false, false, (short)0, false, false, null, null, null, false, false, false, false, null, (byte)0, false, (short)0 }, { 3, (byte)0, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, null, false, false, false, false, (short)0, false, false, null, null, null, false, false, false, false, null, (byte)0, false, (short)0 }, { 2, (byte)0, 0, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, null, false, false, false, false, (short)0, false, false, null, null, null, false, false, false, false, null, (byte)0, false, (short)0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 2, true, 2, null, (short)0, "1;3", 1 }, { 5, true, 2, null, (short)0, "1;3", 0 }, { 4, true, 1, null, (short)0, "0", 1 }, { 1, true, 1, null, (short)0, "0", 0 }, { 3, true, 3, null, (short)0, "2;3", 0 }, { 6, false, 3, null, (short)0, "2;3", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 1, 3 }, { 1, 5 }, { 2, 4 }, { 1, 4 }, { 3, 3 }, { 2, 3 }, { 4, 2 }, { 3, 5 }, { 2, 2 }, { 1, 2 }, { 1, 1 }, { 2, 5 }, { 3, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values : new object[, ]
                { { 3, "Amir", 3, "Fakhim-Babaei", "$2a$11$8deZ26oYOfYxkyse6SXgV.ZMpYrSzC6Tp38zxz7YCSaaDWn6C2LRS", "operator" }, { 2, "Amir", 2, "Fakhim-Babaei", "$2a$11$0yUOIvyraoC/YaFk4ip0z.zTolIaddmW4iXS8xdp4/lOZxGNNIssa", "admin" }, { 1, "Amir", 1, "Fakhim-Babaei", "$2a$11$oqiP/XA3NCo5.pcOes9CRehzHB0ffjCgOSsitxdUZxQPRikLClTHW", "expert" }
                });
