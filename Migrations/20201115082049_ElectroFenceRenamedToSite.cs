    ...
    public partial class ElectroFenceRenamedToSite : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "Amir", 3, "Fakhim-Babaei", "$2a$11$a.P3ToHmDquwTSpzNELkx.Us2vShCcEh3Uz0pGZCWs53AZwJLi55S", "operator" },
                    { 2, "Amir", 2, "Fakhim-Babaei", "$2a$11$oVqN7mxLE15uCbM5kBOvteGYab3/Yic6Ibrzcj28Nf6BeqHD.h1VK", "admin" },
                    { 1, "Amir", 1, "Fakhim-Babaei", "$2a$11$FtBN2MxIs12/MOj9fjcAm.nslgRY8fPMGe7jFD8O81.WzUSIzPWiS", "expert" }
                });
